    ...
    public partial class admin_user : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    String insert = util.iud("INSERT INTO all_table (f1, f2, status ) values ('" + f1.Text + "','" +f2.Text + "','" + status.Text + "')");
                    if (insert == "sucess")
                    {
                ...
                {
                    String insert = util.iud("update all_table set f1='" + f1.Text + "', f2='" + f2.Text + "' where id=" + lb1_id.Text + "");
                    if (insert == "sucess")
                    {
        ...
        private void load_grid()
        {
            ...
            {
                sno=sno + 1;
                grd.Rows.Add(drow["id"],sno, drow[2], "*****");
            }
        }
